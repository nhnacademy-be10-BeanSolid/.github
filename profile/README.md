...
- Object Storage or Image를 이용하여 도서 이미지 고나리 기능 구현
...
### 🙇‍♀️ 마이페이지
- 회원 정보 확인 및 수정 기능 구현 (윤채영)
- 쿠폰 내역 조회 기능 구현 (하정수)
- 포인트 사용내역 조회 기능 구현 (장지엽)
- 좋아요한 도서 조회 기능 구현 (윤채영, 이승민)

### 🧯 기타
- spring cache 적용 (나일환)
- Thymeleaf 기반의 Layout template 구현 (장지엽)
- ConfigServer 구축 (나일환)
- 부하 테스트(스트레스 테스트) 구현 (엄준식)
